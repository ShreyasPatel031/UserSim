...
def main() -> int:
    ap = argparse.ArgumentParser(description="e2e2 matrix — product URL is configurable")
    ap.add_argument("--base", default=os.environ.get("E2E_BASE", "https://usersim.vercel.app"))
    ap.add_argument(
        "--url",
        default=os.environ.get("E2E2_URL", "https://useagency.dev/"),
        help="Product URL under test (env E2E2_URL)",
    )
    ap.add_argument(
        "--competitors",
