...
# 180s/step lets a single hung page burn 90+ min across 30 steps. Fleet default 90s.
STAGE1_STEP_TIMEOUT = int(os.environ.get("BROWSER_USE_STEP_TIMEOUT", "90" if FAST_BAKEOFF else "90"))
