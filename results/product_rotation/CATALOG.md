...
## Blockers
- Production https://usersim.vercel.app/ still on `app.js?v=86`; PR #32 MERGEABLE — needs merge → deploy for prod demo.
- Full 24-agent YouTube reconfirm: BB capacity freed (~24 free as of Etsy finish); re-running.
