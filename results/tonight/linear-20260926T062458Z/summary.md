...
- `time_to_first_value`: 3.22s (threshold <= 10s from URL submit until the first click, type, or scroll is visible in the live UI) PASS
- `total_time`: 62.018s (threshold <= 480s from URL submit until the report is ready) PASS

- study: 18d86703-93a9-461e-a5e9-787a8ac5b927
- product: https://linear.app
- pass: true
- failure file: results/tonight/linear-20260926T062458Z/failures.json
- failed runs: our infrastructure=0, model timeout=0, stuck=0, product=8, no_first_action=0

| Gate | Value | Threshold | Result |
| --- | --- | --- | --- |
| Time to first value (`time_to_first_value`) | 3.22s | <= 10s from URL submit until the first click, type, or scroll is visible in the live UI | PASS |
| Total time (`total_time`) | 62.018s | <= 480s from URL submit until the report is ready | PASS |
...
| Study budget (`study_budget`) | 62.5s | <= 480s for the whole study (observed max 408s) | PASS |
| First real action (`first_action`) | not measured | live abort is time_to_first_action | PASS |
| Time to first action (`time_to_first_action`) | median=1.343s max=1.888s n=24/24 | median <= 5s and max <= 10s at 24 agents | PASS |
...
| Bland-style report page (`report_page`) | http://127.0.0.1:3000/report?study=18d86703-93a9-461e-a5e9-787a8ac5b927 | /report?study=<id> shell with overview and trace tabs | PASS |
