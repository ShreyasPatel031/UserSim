...
- study: 22ff7f78-b0da-45ff-9add-837d21f98710
- product: https://linear.app
- pass: false
- failure file: /workspace/results/tonight/linear-20260926T034118Z/failures.json
...
| Study budget (`study_budget`) | 26.2s | <= 480s for the whole study (observed max 408s) | PASS |
...
- product_task_completion: value=0/8 (0%) threshold=>= 50% of product runs (>= 4/8) (judge_yes=0 structural_past_first_screen=0 first_screen_or_opening=8 opening_frame=0 stuck=0 bb_losses_in_product=0)
